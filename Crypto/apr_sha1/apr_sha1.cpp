...
void apr_sha1_update_binary(apr_sha1_ctx_t *sha_info,
...
void apr_sha1_update(apr_sha1_ctx_t *sha_info, const char *buf,
    unsigned int count)
{
#if APR_CHARSET_EBCDIC
    int i;
...
void apr_sha1_hex(const char *clear, int len, apr_byte_t *out)
{

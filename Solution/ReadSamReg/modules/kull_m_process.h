...
typedef struct _LDR_DATA_TABLE_ENTRY64
{
	...
	DWORD64/*PVOID*/ DllBase;
	DWORD64/*PVOID*/ EntryPoint;
	ULONG SizeOfImage;
...
typedef struct _PEB_LDR_DATA64 {
	ULONG Length;
	BOOLEAN Initialized;
	DWORD64/*PVOID*/ SsHandle;
	LIST_ENTRY64 InLoadOrderModulevector;
	LIST_ENTRY64 InMemoryOrderModulevector;
	LIST_ENTRY64 InInitializationOrderModulevector;
...
// 		BYTE SpareBits : 7;
// 	};
	DWORD64/*HANDLE*/ Mutant;
	DWORD64/*PVOID*/ ImageBaseAddress;
	DWORD64/*PPEB_LDR_DATA*/ Ldr;
	/// ...
} PEB64, *PPEB64;
...
typedef struct _PROCESS_BASIC_INFORMATION64 {
	NTSTATUS ExitStatus;
	DWORD64/*PPEB*/ PebBaseAddress;
	DWORD64/*ULONG_PTR*/ AffinityMask;
	KPRIORITY BasePriority;
	DWORD64/*ULONG_PTR*/ UniqueProcessId;
	DWORD64/*ULONG_PTR*/ InheritedFromUniqueProcessId;

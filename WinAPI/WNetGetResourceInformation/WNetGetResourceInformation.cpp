// WNetGetResourceInformation.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
CheckServer(LPWSTR pszServer)
{
    ...
    DisplayStruct(0, (LPNETRESOURCE)lpBuffer);
...
int main()
{
    ...
    CheckServer(PTSTR(L"\\\\WIN-1NMHTJKVJBO\\Users\\Administrator.WIN-1NMHTJKVJBO\\Desktop\\Exchange"));
    // CheckServer(LPWSTR(L"Web Client Network"));
